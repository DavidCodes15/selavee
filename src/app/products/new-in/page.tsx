...
const SORT_OPTIONS = {
  ...
  name: 'sort',
  options: [
    {value: 'best-sellers', label: 'Best Sellers', selected: false},
    {value: 'new-in', label: 'New Arrivals', selected: true},
...
const NewIn = ({ searchParams }: PageProps) => {
            ...
            <div className="flex flex-col-reverse lg:flex-row w-full justify-center px-4 lg:px-0">
              ...
              {categoryLoading ? (
                  ...
                  {data?.products.length === 0 ? (
                    ...
                    <img className="h-[293px]" src={data?.products[0].newIns} />
                  )}
                  </>
                )}
              </div>
