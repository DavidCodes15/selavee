    ...
    return (
        <>
            <div>
                ...
                <span className='tracking-widest text-white text-[24px] font-semibold'>Terms Of Use</span>
                </div>
                <div className='mt-12 w-full flex justify-center items-start space-x-28'>
                    ...
                    {selectedSection === "scope" && (
                            ...
                            This Terms of use describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You. We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. The Privacy Policy is a part of the Terms of Service (also known as the “Terms”), which apply to all aspects of this Privacy Policy. The terms "Sela Vee," "we," “our,” and "us" include Sela Vee LLC and our affiliates and subsidiaries. The Privacy Policy explains our online and offline information practices, the kinds of information we may collect, how we intend to use and share that information, and how you can opt out of a use or correct or change such information. Unless defined in this Privacy Policy, all capitalized terms used herein have the same meanings as in our Terms of Service. 
                            </p>
                       )}
                       {selectedSection === "rights" && (
                        <p className='tracking-widest text-white w-[600px]'>

                        Page 2 Terms of use describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You. We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. The Privacy Policy is a part of the Terms of Service (also known as the “Terms”), which apply to all aspects of this Privacy Policy. The terms "Sela Vee," "we," “our,” and "us" include Sela Vee LLC and our affiliates and subsidiaries. The Privacy Policy explains our online and offline information practices, the kinds of information we may collect, how we intend to use and share that information, and how you can opt out of a use or correct or change such information. Unless defined in this Privacy Policy, all capitalized terms used herein have the same meanings as in our Terms of Service. 
                        </p>
                       )}
                       {selectedSection === "collection" && (
                        <p className='tracking-widest text-white w-[600px]'>

                        Page 3 Terms of use describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You. We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. The Privacy Policy is a part of the Terms of Service (also known as the “Terms”), which apply to all aspects of this Privacy Policy. The terms "Sela Vee," "we," “our,” and "us" include Sela Vee LLC and our affiliates and subsidiaries. The Privacy Policy explains our online and offline information practices, the kinds of information we may collect, how we intend to use and share that information, and how you can opt out of a use or correct or change such information. Unless defined in this Privacy Policy, all capitalized terms used herein have the same meanings as in our Terms of Service. 
                        </p>
                       )}
                       {selectedSection === "info" && (
                        <p className='tracking-widest text-white w-[600px]'>

                        Page 4 Terms of use describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You. We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. The Privacy Policy is a part of the Terms of Service (also known as the “Terms”), which apply to all aspects of this Privacy Policy. The terms "Sela Vee," "we," “our,” and "us" include Sela Vee LLC and our affiliates and subsidiaries. The Privacy Policy explains our online and offline information practices, the kinds of information we may collect, how we intend to use and share that information, and how you can opt out of a use or correct or change such information. Unless defined in this Privacy Policy, all capitalized terms used herein have the same meanings as in our Terms of Service. 
                        </p>
                       )}
